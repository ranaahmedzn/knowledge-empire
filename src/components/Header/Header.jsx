      ...
      <div className="navbar">
        ...
        <div className="flex-none gap-10">
          <div className="hidden md:block">
            <NavLink
              ...
              className={`${({ isActive }) =>
                isActive
                  ? "active"
                  : ""} text-lg font-bold ml-8 hover:border-b-4 p-1 border-indigo-500 transition-all duration-75`}
            >
              Home
            </NavLink>
            <NavLink
          ...
          >
            <ul
              className={`${
                isOpen ? "top-24 left-0" : "top-24 -left-[1000px]"
              } duration-500 absolute px-5 py-8 mt-2 bg-gray-800 text-slate-100 w-full flex flex-col gap-6`}
            >
              <li>
                <NavLink
                  to="/"
                  className={`${({ isActive }) =>
                    isActive
                      ? "active"
                      : ""} text-lg font-bold hover:border-b-4 p-1 border-indigo-500 transition-all duration-75`}
                >
                  Home
                </NavLink>
              </li>
              ...
              <li>
                <a
                  href="#"
                  className="text-lg font-bold hover:border-b-4 p-1 border-indigo-500 transition-all duration-75"
                >
                  <FontAwesomeIcon icon={faRightToBracket} />
                  &nbsp; Login
                </a>
